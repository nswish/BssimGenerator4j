...
public class JspModel {
    ...
    public JspModel(TableModel table) {
        this.table = table;
    }
    ...
    public String toCode(Map config) {
        ...
        try {
            ...
            String jspName = config.get("jspName")+"";
            List   queryList = (List)config.get("queryList");
            ...
            root.put("jspName", jspName);
            root.put("queryList", queryList);

            Template tmpl = cfg.getTemplate("jsp.ftl");
